...
export default async function Dashboard() {
  ...
  const avatarUrl = user.avtarurl || 'https://api.dicebear.com/9.x/pixel-art/svg';
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-900  shadow-md rounded-lg p-6 mb-6">
              ...
              <div className="flex items-center justify-between">
                <h2 className="text-2xl text-primary font-bold">Hi, {user.firstName} {user.lastName}</h2>
                <ShareModal shareUrl={user.username} />
              </div>
              <p className="text-gray-500">nimboo.com/<span className="text-primary">{user.username}</span></p>
            </div>
            {/* Earnings Section */}
            <div className="bg-white dark:bg-gray-900  shadow-md rounded-lg p-6 mb-6">
              <div className="flex items-center justify-between">
            ...
            <div className="bg-white dark:bg-gray-900  shadow-md rounded-lg p-6 text-center">
              ...
              <p className="text-gray-500">Share your page with your audience to get started.</p>
            </div>
          </div>
        </main>
      </div>
