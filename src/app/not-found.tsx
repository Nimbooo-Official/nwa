  ...
  return(
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background text-center px-4">
      ...
      <div className="flex flex-col mt-20 items-center mb-32">
        ...
        {/* Error message */}
        <h2 className="font-bold text-4xl mt-8 text-primary animate-bounce">Oops! Page Not Found</h2>
        <p className="text-xl mt-4 text-secondary-foreground">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        </p>
        
        {/* Back to Home button */}
        <Link href="/" className="mt-8 bg-primary text-white px-4 py-2 rounded-md text-lg font-semibold hover:text-secondary-foreground transition">
